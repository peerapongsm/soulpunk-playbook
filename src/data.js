export const data = {
  ...
  th: {
    ...
    sections: [
      ...
      {
        title: "ภูมิหลังตัวละคร (Backgrounds)",
        subsections: [
          {
            title: "โดรนองค์กร (ที่กำลังฟื้นตัว)",
            content: "คุณใช้เวลาทั้งชีวิตทำงานเป็นทาสให้กับหนึ่งใน Megacorp จนกระทั่งความผิดพลาดทางเอกสารหรือการโจมตีของกลุ่มกบฏปลดแอกคุณออกมา",
            list: [
              "**ทักษะความชำนาญ:** Investigation, Persuasion",
              "**ความชำนาญเครื่องมือ:** ชุดเกมกระดาน 1 ประเภท, ชุดเครื่องมือปลอมแปลง ID องค์กร 1 ชุด",
              "**ความสามารถ - สายพานองค์กร:** คุณรู้จักการทำงานภายในของระบบราชการในองค์กรเป็นอย่างดี คุณมักจะรู้ว่าต้องติดสินบนหรือแทรกซึมแผนกไหน และสามารถถอดรหัสสัญญาผูกมัดวิญญาณที่ซับซ้อนได้"
            ]
          },
          {
            title: "แฮกเกอร์วิญญาณแห่ง Ethereal",
            content: "คุณท่องไปใน Border Ethereal เพื่อขโมยข้อมูลและเขียนสัญญาเวทมนตร์ขึ้นใหม่",
            list: [
              ...
              "**ความสามารถ - ประตูหลัง:** คุณสามารถค้นหาโหนดที่ซ่อนอยู่เพื่อเชื่อมต่อกับเครือข่าย Ethereal ได้โดยไม่ต้องใช้ล็อกอินขององค์กร ซึ่งจะช่วยให้คุณเข้าถึงข้อมูลพื้นฐานและแผนที่ของพื้นที่องค์กรได้"
            ]
          },
          {
            title: "นักเก็บกู้แห่ง Bleed",
            content: "คุณเอาชีวิตรอดด้วยการฝ่าฟันแดนรกร้าง Eldritch Wasteland นอกเขต Grid เพื่อตามหาทองคำจากโลกยุคเก่า",
            list: [
              "**ทักษะความชำนาญ:** Survival, Perception",
              "**ความชำนาญเครื่องมือ:** เครื่องมือนำทาง, ชุดเครื่องมือช่าง",
              "**ความสามารถ - นักนำทางซากปรักหักพัง:** คุณสามารถค้นหาเส้นทางที่ปลอดภัยฝ่าพายุเวทมนตร์ที่คาดเดาไม่ได้ใน The Bleed ได้เสมอ และรู้แหล่งรับซื้อโบราณวัตถุเพื่อแลกกับทองคำที่ไร้ร่องรอย"
            ]
          }
        ]
      },
      {
        title: "ขั้วอำนาจ (Factions)",
        list: [
          "**The Infernal Syndicate (Fiends):** ควบคุมอุตสาหกรรมหนัก อาวุธ และการบังคับใช้กฎหมาย มีสุนทรียศาสตร์แบบ Brutalist ที่เต็มไปด้วยนีออนสีแดง และสัญญาผูกมัดที่แข็งแกร่งดั่งเหล็กกล้า",
        ...
        subsections: [
          {
            ...
            list: [
              ...
              "**Neon-Hell Sector:** เขตอุตสาหกรรมที่เต็มไปด้วยหมอกควัน ดำเนินการโดย The Infernal Syndicate",
              "**The Roots:** สลัมใต้ดินที่บริหารจัดการโดย The Deep Network เป็นสวรรค์ของนักเจรจา (Fixer) ในตลาดมืดและ Ripperdoc"
            ]
          },
          {
            title: "The Bleed",
            content: "แดนรกร้าง Eldritch Wasteland ที่ล้อมรอบ Grid อยู่ มันเต็มไปด้วยซากเมืองปรักหักพังจากช่วงปี 1490s DR พายุเวทมนตร์ที่ผันผวน และสัตว์ประหลาดกลายพันธุ์ที่น่าสะพรึงกลัว นักเก็บกู้จะมุ่งหน้ามาที่นี่เพื่อขุดหาทองคำ (GP) ที่ไร้ร่องรอย"
          },
          {
            title: "The Ethereal (ไซเบอร์สเปซ)",
            content: "มิติ Border Ethereal ที่ถูกยึดครองโดยเหล่า Patron เพื่อใช้เป็นเครือข่ายข้อมูลเวทมนตร์ขั้นสุดยอด จิตใจจะถูกฉายภาพมาที่นี่เพื่อเซ็นสัญญา ขโมยข้อมูล หรือลาดตระเวนหาแฮกเกอร์"
          }
        ]
      },
      {
        title: "ตัวละคร NPC สำคัญ",
        list: [
          "**\"Glitch\" (Soulhacker Fixer):** ผู้ติดต่อสุดประหลาดจาก Deep Network ผู้ดำเนินงานจากบังเกอร์ที่เต็มไปด้วยคลื่นรบกวนใน The Roots เธอขาย Projector ผิดกฎหมายและหินสื่อสารทองคำ",
          "**Exec-Commander Valerius (Infernal Syndicate):** มือสังหาร Hex Blade สุดเหี้ยมขององค์กร ผู้ได้รับมอบหมายให้ตามล่าสมาชิกของ The Disconnect",
          "**Mother Willow (Archfey Conglomerate):** ซีอีโอผู้มีเสน่ห์ดึงดูดจากสาขาเวชภัณฑ์ที่ใหญ่ที่สุด ผู้ซ่อนร่างที่แท้จริงอันน่าสะพรึงกลัวของเผ่า Fey ไว้ภายใต้ภาพลวงตาหลอนประสาท",
          "**Brother Kael (Ripperdoc):** นักบวชแห่ง Lathander ผู้เคร่งขรึมและเปิดคลินิกใต้ดิน เขารักษาเหล่า Null-Punks ด้วยเวทมนตร์ศักดิ์สิทธิ์ที่ไร้ร่องรอย โดยขอเพียงทองคำเป็นการตอบแทน"
        ]
      },
      {
        title: "ภัยคุกคาม (Threats)",
        list: [
